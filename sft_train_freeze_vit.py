...
def parse_args():
    parser = argparse.ArgumentParser(description="SFT SparkVLM (ViT Frozen)")
    ...
    parser.add_argument("--output_dir", type=str, default="save/vlm_sft_freeze_vit")
...
def main():
    ...
    # 冻结 ViT，只训练 Adapter (linear1 + linear2) + LLM
    print("Freezing ViT, training Adapter + LLM only...")
    ...
    print("Starting SFT Training (ViT Frozen) ...")
    trainer.train()
